sap.ui.define(
  ...
  function (Controller, History, Fragment, MessageToast, MessageBox, bufferedEventHandler) {
    ...
    return Controller.extend("com.ingenx.nauti.masterdashboard.controller.RefDocIndicator", {
      ...
      onCodeLiveChange: function (oEvent) {
        ...
        // Check if the length of the value exceeds 1
        if (sValue.length > 1) {
          // Truncate the value to keep only the first 1 characters
          ...
          // Show a message to the user
          sap.m.MessageToast.show("Maximum length is 1 characters.");
        }
      },
      ...
      selectedItems: function (oEvent) {
        ...
        aSelectedIds = aSelectedItems.map(function (oSelectedItem) {
          ...
          if (oSelectedItem.getBindingContext()) {
            ...
            return [oSelectedItem.getBindingContext().getProperty("Docind"), oSelectedItem.getBindingContext().getProperty("Docdesc")]
      ...
      pressEdit: function () {
        ...
        aSelectedItems.forEach(function (oItem) {
          ...
          var sValue = oBindingContext.getProperty("Docind");
          var sDescription = oBindingContext.getProperty("Docdesc");
        ...
        aSelectedItems.forEach(function (oSelectedItem) {
          ...
          let sValue = oContext.getProperty("Docind");
          let sDesc = oContext.getProperty("Docdesc");
      ...
      onSave1: function () {
        ...
        var value1 = this.getView().byId("Code").getValue();
        var value2 = this.getView().byId("Desc").getValue();
        ...
        let oBindListSP = oModel.bindList("/RefrenceDocumentSet");
        ...
        oBindListSP.attachEventOnce("dataReceived", function () {
          let existingEntries = oBindListSP.getContexts().map(function (context) {
            return context.getProperty("Docind");
          });
      ...
      formatUomdes: function (Docdesc) {
        return Docdesc.toLowerCase().replace(/\b\w/g, function (char) {
