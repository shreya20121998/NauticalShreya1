sap.ui.define(
  ["jquery.sap.global", "sap/ui/core/Control", "./library"],

  function (jQuery, Control, library) {
    "use strict";

    var LeafletMap = Control.extend("com.ingenx.nauti.createvoyage.custom.marineMap.MarineMap", {
    ...
    //     [51.505, -0.09],
    //     this.getDefaultZoomLevel()
    //   ); //pos, zoom-level;  store globally (there is probably a better way...)
    ...
    // LeafletMap.prototype.highlightAreas = function (
    //   aAreas,
    //   bPermanentTooltips
    // ) {
    //   var myStyle = {
    ...
    //     })
    //       .bindTooltip(
    //         oAreaGeoJson.properties.LEVEL3_NAM +
    //           " (" +
    //           oAreaGeoJson.properties[this.getGeoJsonPropertyKey()] +
    //           ")",
    //         {
